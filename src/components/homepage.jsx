...
// const countries = [
//   { value: "Georgia", label: "საქარტველო" },
//   { value: "Russia", label: "რუსეთი" },
//   { value: "Spain", label: "ესპანეთი" },
...
//                 უნივერსიტეტების საძიებო სისტემა
//               </Title>
//               <Space>
//                 {temperature !== null ? (
//                   <span style={{ fontSize: "20px", color: "red" }}>
//                     {temperature}°C Tbilisi
//                   </span>
//                 ) : (
//                   <Spin size="small" />
//                 )}
